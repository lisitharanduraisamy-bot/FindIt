/* ==========================================================
   FINDIT: USER PROFILE & REPORTS TRACKER VIEW
   ========================================================== */
    ...
    async render() {
        ...
        return `
            <div style="display: flex; flex-direction: column; gap: 24px;">
                ...
                <!-- Split Layout -->
                <div class="browse-layout" style="display: grid; grid-template-columns: 340px 1fr; gap: 32px; align-items: start;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 24px;">
                        ...
                        <div class="card" style="padding: 24px; text-align: center; display: flex; flex-direction: column; align-items: center; gap: 16px;">
                            ...
                            <div>
                                <h3 style="font-size: 18px; font-weight: 700; color: var(--color-on-surface);">${user.name}</h3>
                        ...
                        <div class="card" style="padding: 24px;">
                            ...
                            <form id="form-update-profile" style="display: flex; flex-direction: column; gap: 14px;">
                                ...
                                <div class="form-group" style="margin-bottom: 0;">
                                    ...
                                    <input type="tel" id="edit-profile-phone" class="form-input" value="${user.phone || ''}" placeholder="(555) 123-4567">
                                </div>
                                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <div class="card" style="padding: 0; overflow: hidden; min-height: 480px; display: flex; flex-direction: column;">
                        ...
                        <div style="background-color: var(--color-surface-low); border-bottom: 1px solid var(--color-surface-container); display: flex;">
                            <button class="profile-tab-btn ${this.activeTab === 'lost' ? 'active' : ''}" id="tab-btn-lost" style="flex: 1; padding: 16px 20px; font-weight: 700; font-size: 14px; text-align: center; border-bottom: 3px solid ${this.activeTab === 'lost' ? 'var(--color-primary)' : 'transparent'}; color: ${this.activeTab === 'lost' ? 'var(--color-primary)' : 'var(--color-on-surface-variant)'};">
                                <i class="fa-solid fa-triangle-exclamation" style="margin-right: 6px;"></i> My Lost Listings (${myLost.length})
                            </button>
                            <button class="profile-tab-btn ${this.activeTab === 'found' ? 'active' : ''}" id="tab-btn-found" style="flex: 1; padding: 16px 20px; font-weight: 700; font-size: 14px; text-align: center; border-bottom: 3px solid ${this.activeTab === 'found' ? 'var(--color-primary)' : 'transparent'}; color: ${this.activeTab === 'found' ? 'var(--color-primary)' : 'var(--color-on-surface-variant)'};">
                                <i class="fa-solid fa-box-open" style="margin-right: 6px;"></i> My Found Listings (${myFound.length})
                            </button>
                            <button class="profile-tab-btn ${this.activeTab === 'claims' ? 'active' : ''}" id="tab-btn-claims" style="flex: 1; padding: 16px 20px; font-weight: 700; font-size: 14px; text-align: center; border-bottom: 3px solid ${this.activeTab === 'claims' ? 'var(--color-primary)' : 'transparent'}; color: ${this.activeTab === 'claims' ? 'var(--color-primary)' : 'var(--color-on-surface-variant)'};">
                        ...
                        ${items.map(item => {
                            ...
                            return `
                                <tr style="border-bottom: 1px solid var(--color-surface-container); transition: background 0.2s;" onmouseover="this.style.backgroundColor='var(--color-surface-low)'" onmouseout="this.style.backgroundColor='transparent'">
                                    ...
                                    <td style="padding: 16px; font-weight: 600; color: var(--color-on-surface);">${item.name}</td>
    ...
    attachEvents(app) {
        ...
        if (formUpdate) {
            formUpdate.addEventListener("submit", async (e) => {
                ...
                const major = document.getElementById("edit-profile-major").value;
