            ...
            <div style="display: flex; flex-direction: column; gap: 24px;">
                ...
                <div class="browse-layout" style="display: grid; grid-template-columns: 280px 1fr; gap: 24px; align-items: start;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 20px;">
                        ...
                        <div style="background-color: var(--color-surface-low); border: 1px solid var(--color-surface-container); border-radius: var(--rounded-md); padding: 12px 16px; display: flex; flex-direction: column; gap: 10px;">
                            <span style="font-size: 11px; font-weight: 800; color: var(--color-outline); text-transform: uppercase; letter-spacing: 0.05em; display: flex; align-items: center; gap: 6px;">
                                <i class="fa-solid fa-map-location-dot" style="color: var(--color-primary);"></i> Location Cluster Pills
                            </span>
                            <div style="display: flex; flex-wrap: wrap; gap: 8px;" id="location-cluster-pills">
                                <button type="button" class="location-pill" data-location="" style="font-size: 12px; font-weight: 700; padding: 4px 12px; border-radius: 100px; border: 1px solid ${!this.filters.location ? 'var(--color-primary)' : 'var(--color-surface-container)'}; background-color: ${!this.filters.location ? 'var(--color-primary)' : 'var(--color-surface-high)'}; color: ${!this.filters.location ? '#ffffff' : 'var(--color-on-surface)'}; cursor: pointer; transition: all 0.2s;">
                                    All Clusters
                                </button>
                                <button type="button" class="location-pill" data-location="Library" style="font-size: 12px; font-weight: 700; padding: 4px 12px; border-radius: 100px; border: 1px solid ${this.filters.location === 'Library' ? 'var(--color-primary)' : 'var(--color-surface-container)'}; background-color: ${this.filters.location === 'Library' ? 'var(--color-primary)' : 'var(--color-surface-high)'}; color: ${this.filters.location === 'Library' ? '#ffffff' : 'var(--color-on-surface)'}; cursor: pointer; transition: all 0.2s; display: flex; align-items: center; gap: 6px;">
                                    <i class="fa-solid fa-book" style="font-size: 11px;"></i> Library
                                </button>
                                <button type="button" class="location-pill" data-location="Gym" style="font-size: 12px; font-weight: 700; padding: 4px 12px; border-radius: 100px; border: 1px solid ${this.filters.location === 'Gym' ? 'var(--color-primary)' : 'var(--color-surface-container)'}; background-color: ${this.filters.location === 'Gym' ? 'var(--color-primary)' : 'var(--color-surface-high)'}; color: ${this.filters.location === 'Gym' ? '#ffffff' : 'var(--color-on-surface)'}; cursor: pointer; transition: all 0.2s; display: flex; align-items: center; gap: 6px;">
                                    <i class="fa-solid fa-dumbbell" style="font-size: 11px;"></i> Gym
                                </button>
                                <button type="button" class="location-pill" data-location="Cafeteria" style="font-size: 12px; font-weight: 700; padding: 4px 12px; border-radius: 100px; border: 1px solid ${this.filters.location === 'Cafeteria' ? 'var(--color-primary)' : 'var(--color-surface-container)'}; background-color: ${this.filters.location === 'Cafeteria' ? 'var(--color-primary)' : 'var(--color-surface-high)'}; color: ${this.filters.location === 'Cafeteria' ? '#ffffff' : 'var(--color-on-surface)'}; cursor: pointer; transition: all 0.2s; display: flex; align-items: center; gap: 6px;">
                                    <i class="fa-solid fa-utensils" style="font-size: 11px;"></i> Cafeteria
                                </button>
                                <button type="button" class="location-pill" data-location="Science" style="font-size: 12px; font-weight: 700; padding: 4px 12px; border-radius: 100px; border: 1px solid ${this.filters.location === 'Science' ? 'var(--color-primary)' : 'var(--color-surface-container)'}; background-color: ${this.filters.location === 'Science' ? 'var(--color-primary)' : 'var(--color-surface-high)'}; color: ${this.filters.location === 'Science' ? '#ffffff' : 'var(--color-on-surface)'}; cursor: pointer; transition: all 0.2s; display: flex; align-items: center; gap: 6px;">
                                    <i class="fa-solid fa-flask" style="font-size: 11px;"></i> Science Quad
                                </button>
                                <button type="button" class="location-pill" data-location="Quad" style="font-size: 12px; font-weight: 700; padding: 4px 12px; border-radius: 100px; border: 1px solid ${this.filters.location === 'Quad' ? 'var(--color-primary)' : 'var(--color-surface-container)'}; background-color: ${this.filters.location === 'Quad' ? 'var(--color-primary)' : 'var(--color-surface-high)'}; color: ${this.filters.location === 'Quad' ? '#ffffff' : 'var(--color-on-surface)'}; cursor: pointer; transition: all 0.2s; display: flex; align-items: center; gap: 6px;">
